    ...
    <div class="container">
          <div class="row row-1">
            ...
            <div class="col-md-2 login-btn">
              <button type="submit" class="login-image"><img src="/images/person_shards.png" alt="login" class="login-btn-image"/>Login</button>
            </div> 
      </div> <!--/row-->
    </div> <!--/container-->
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shards\resources\views/pages/login.blade.php ENDPATH**/ ?>